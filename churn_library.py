...
def perform_feature_engineering(dataframe):
	...
	x_training, x_testing, y_training, y_testing = train_test_split(x_values, y_values, \
...
def classification_report_image(y_training,
	...
	plt.text(0.01, 0.05, str(classification_report(y_testing, y_test_preds_rf)), \
	...
	plt.text(0.01, 0.05, str(classification_report(y_training, y_train_preds_rf)), \
		{'fontsize': 10}, fontproperties = 'monospace')
	plt.axis('off')
	...
	plt.text(0.01, 0.05, str(classification_report(y_testing, y_test_preds_lr)), \
		{'fontsize': 10}, fontproperties = 'monospace')
	plt.axis('off')
	...
	plt.text(0.01, 0.05, str(classification_report(y_training, y_train_preds_lr)), \
	{'fontsize': 10}, fontproperties='monospace')
	plt.axis('off')
